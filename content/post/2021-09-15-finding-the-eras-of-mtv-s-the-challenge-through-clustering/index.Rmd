...
I can then visualize the resulting dendrogram using the `plot()` function and supplying the short_title field I can previously excluded as a label parameter.  By looking at the dendrogram it seems like there are five clusters which I will highlight with the `rect.hclust` function and specifying k=5:
