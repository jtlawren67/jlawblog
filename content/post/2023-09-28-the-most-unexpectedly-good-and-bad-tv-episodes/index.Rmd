...
* The show started in 1990 or later (this is more because I wanted things I'd be familiar with)
...
The methodology I'm going to use to determine what's an **unexpectedly** good or bad episode of TV is similar to the methodology used in the [tsoutliers() function in the forecast packages](https://robjhyndman.com/hyndsight/tsoutliers/).  Although since this isn't really a time-series (at least the episode orders don't have any real meaning), I'll be modifying it slightly.  My method is:
...
Surprisingly, at least to me, Sponge-Bob Squarepants has the most **unexpected** episodes with 5 and they're all unexpectedly bad.  This is in contrast with Desperate Housewives and Big Bang Theory which have 4 and 3 unexpected episodes which are all good.  
